...
def demo_cases() -> list[Case]:
    primary = Case(
        ...
        manifest=Manifest(
            ...
            paths=(ManifestPath(id="PATH-01", definition="MaterialSubstitution", title="物料替代", rationale="并行确认 A/B 的供应、技术与客户接受度。"),),
            policy_refs=("POL-SUBSTITUTION-3", "POL-CUSTOMER-2"), experience_refs=("EXP-2025-041",),
        ),
    )
    related = [
