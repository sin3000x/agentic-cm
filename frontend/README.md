...
从侧栏「关于项目」进入 `/about`。六页依次介绍流程与 Case、角色与求解、能力与责任、Case 工作流、三类平台资产和四层技术架构。
点击「导出 PDF slides」，在浏览器打印对话框中选择「另存为 PDF」，关闭页眉和页脚，保留默认缩放。打印样式自动采用 320 × 180 mm（16:9），隐藏导航，一张幻灯片对应一页。手机端使用纵向阅读布局，图示可横向滚动；导出仍保持横向 slides。
